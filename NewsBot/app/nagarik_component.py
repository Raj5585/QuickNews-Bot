...
class Nagarik(QRComponent):
    ...
    def convertoenglish(self, date):
        ...
        lstnew = [str(int(extracted_date[2])),str(nepali_months_mapping[extracted_date[1]]), extracted_date[0]]
    ...
    def scrape(self):
        ...
        for keyword in keywords:
            ...
            time.sleep(1)
            articles = self.browser.find_elements('//article[contains(@class,"list-group-item")]/div[@class="text"]')
            for div in articles:
                try:
