...
class QREnv:
    ...
    URL_UAT_URL ="http://18.217.209.236/api/v1"                                  # Use for client uat server
    URL_PROD = "http://18.217.209.236/api/v1"                                             # Use for client production
